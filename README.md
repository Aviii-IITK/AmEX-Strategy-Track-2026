...
1. **Negative results are purchases, not failures.** Every falsified hypothesis constrained the target's structure; the winning configuration was found mostly by elimination.
...
3. **Masked features are not what they seem.** A feature labeled "total spend" proved numerically incompatible with dollar-scale spend (likely transformed/scaled), decisively falsified by a single controlled test.
